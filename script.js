...
//São cinco objetos, contendo informações
/*Acessar um em campo em particular
meiaNoite.pasta 

Acessar um campo com valor na lista
minhaLista[3] - indice 3*/
const verdeCipreste = {
    nome: 'Verde-cipreste',
...
function trocarImagem() {    //Buscando imagem com o nome "opção-imagem", mas que esteja marcado
